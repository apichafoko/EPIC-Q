...
export default function ReportsPage() {
  ...
  const selectAllHospitals = () => {
    // This would need to be implemented with real hospital data
          ...
          {loading ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
              <div className="text-center">
                <div className="text-3xl font-bold text-blue-600">{summary.totalHospitals}</div>
                <div className="text-sm text-gray-600">Hospitales Totales</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-green-600">{summary.activeHospitals}</div>
                <div className="text-sm text-gray-600">Hospitales Activos</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-purple-600">{summary.totalCases.toLocaleString()}</div>
                <div className="text-sm text-gray-600">Casos Registrados</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-orange-600">{summary.averageCompletion}%</div>
